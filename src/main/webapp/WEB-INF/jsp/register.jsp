                        ...
                        <div class="row ">
                            <div class="col-8 col-sm-8 mx-auto my-auto">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="firstName" placeholder= "First Name" id="InputFirstName" pattern="^[a-zA-Z ]*$" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="lastName" placeholder= "Last Name" id="InputLastName" pattern="^[a-zA-Z ]*$" required>
                                    <div class="invalid-feedback">
                                        Please enter a valid name without numbers or special characters
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control form-control-lg" name="email" placeholder= "Email*" id="InputEmail" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control form-control-lg" name="phone" placeholder= "123-456-7890"  id="InputNumber"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control form-control-lg" name="password" placeholder= "Password*" id="InputPassword"
                                           pattern="^\S{6,}$"
