                        ...
                        <div class="row ">
                            <div class="col-8 col-sm-8 mx-auto my-auto">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="firstName" value= "${accountFormBean.firstName}" id="editFirstName" pattern="^[a-zA-Z ]*$" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="lastName" value= "${accountFormBean.lastName}" id="editLastName" pattern="^[a-zA-Z ]*$" required>
                                    <div class="invalid-feedback">
                                        Please enter a valid name without numbers or special characters
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control form-control-lg" name="email" value= "${accountFormBean.email}" id="editEmail" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control form-control-lg" name="phone" value= "${accountFormBean.phone}"  id="editNumber"
                                           pattern= "[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
                                    <div class= "invalid-feedback">Please provide a valid phone number.
                                    </div>
                                </div>

                                <center><button type="submit" class="btn" form="userAccount">Save Changes</button><center>
