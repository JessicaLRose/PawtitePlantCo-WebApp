            ...
            <div class="modal-body">
                <form action="/admin/productlisting/productSubmit" method="post" id="addProduct">
                    ...
                    <div class="prod-image">
                        ...
                        <br><br>
                        <input type="text" name="productImage" id="add-prod-img" class="input-default"
                    ...
                    <div class="prod-thumb">
                        ...
                        <br><br>
                        <input type="text" name="productThumbnail" id="add-prod-thumb" class="input-default"
                    ...
                    <div class="prod-name">
                        ...
                        <br><br>
                        <input type="text" name="productName" id="add-prod-name" class="input-default"
                    ...
                    <div class="prod-cat">
                        ...
                        <br><br>
                        <input type="text" name="productCategory" id="add-prod-cat" class="input-default"
                    ...
                    <div class="prod-price">
                        ...
                        <br><br>
                        <input type="text" name="productPrice" id="add-prod-price" class="input-default"
                    ...
                    <div class="prod-descrip">
                        ...
                        <br><br>
                        <textarea form="addProduct" name="productDescription" id="add-prod-descrip"
                                  class="input-default" value="${product.productDescription}"></textarea>
                    </div>
                </form>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="/admin/productlisting/delete" method="get" id="deleteProduct"><input type="hidden"
                                                                                                   name="id"
                                                                                                   id="finalDelete"
                                                                                                   value="">
    ...
    <div class=" table-responsive table-wrapper shadow">
        <div class="table-title ">
            <div class="row d-flex ">
                ...
                <div class="col-sm-1 ">
                    <a href="#" class="add" title="Add New" data-toggle="tooltip" data-placement="bottom"
        ...
        <table class="table table-striped">
            ...
            <jstlC:forEach items="${allProducts}" var="product">
                <tr>
                    ...
                    <td>
                        <a href="/admin/productEdit/${product.id}" class="edit" title="Edit" data-toggle="tooltip"
                           data-placement="bottom"><i class="fa-solid fa-pen-to-square"></i></a>
                        <a href="/admin/productlisting/delete/${product.id}" class="delete" title="Delete"
                           data-toggle="tooltip" data-placement="bottom" data-bs-toggle="modal"
                           data-bs-target="#deleteModal" data-bs-whatever="${product.id}"><i
